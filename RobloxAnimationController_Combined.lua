...
local function createMainGUI()
    ...
    pauseButton.TextColor3 = Color3.white
    ...
    resetButton.TextColor3 = Color3.white
    ...
    loopButton.TextColor3 = Color3.white
    ...
    timeDisplay.TextColor3 = Color3.white
    ...
    partsLabel.TextColor3 = Color3.white
    ...
    addKeyframeButton.TextColor3 = Color3.white
    ...
    if isMobile then
        ...
        selectButton.TextColor3 = Color3.white
...
function updatePartsList(gui)
    ...
    for i, part in pairs(animationController.selectedParts) do
        ...
        partLabel.TextColor3 = Color3.white
